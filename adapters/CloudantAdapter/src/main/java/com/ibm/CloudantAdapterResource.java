...
public class CloudantAdapterResource {
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/CloudantAdapter/resource"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/CloudantAdapter/resource/greet?name={name}"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/CloudantAdapter/resource/{path}/"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/CloudantAdapter/resource/prop"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/CloudantAdapter/resource/unprotected"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/CloudantAdapter/resource/protected"
	 */
