...
@implementation GymsScreen1DS

static NSString *const kUrl             = @"https://ibm-pods.buildup.io";
static NSString *const kApiKey          = @"A2InvAsJ";
static NSString *const kResourceId      = @"/app/57d12b711b391b03007f95ef/r/gymsScreen1DS";
...
- (instancetype)init {
    ...
    self = [super initWithUrlString:kUrl 
                       ...
                       objectsClass:[GymsScreen1DSItem class]];
    if (self) {
...
- (NSString *)imagePath:(NSString *)path {
    ...
    return [NSString stringWithFormat:@"https://ibm-pods.buildup.io/app/57d12b711b391b03007f95ef%@?apikey=%@", path, self.apiKey];
}
...
- (NSArray *)searchableFields {
    ...
    return @[kGymsScreen1DSItemName, kGymsScreen1DSItemDescription, kGymsScreen1DSItemPhone, kGymsScreen1DSItemAddress, kGymsScreen1DSItemRating, kGymsScreen1DSItemId];
}
