//
//  CarDealersDetailViewController.h
//  BConnect
//
...
@interface CarDealersDetailViewController ()

@property (nonatomic, strong) ROOptionsFilter *optionsFilter;

@end

@implementation CarDealersDetailViewController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.dataLoader = [[ROSingleDataLoader alloc] initWithDatasource:[[DatasourceManager sharedInstance] screen0DS]
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"CarDealersDetail"];
...
- (void)configureWithDataItem:(Screen0DSItem *)item {
    self.items = @[
